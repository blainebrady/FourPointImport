...
namespace FourPointImport.Data
{
    ...
    public class CoverageInsHist : Base
    {
        ...
        public static void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmStat).HasMaxLength(1);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmCovc).HasPrecision(5, 0);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmTble).HasMaxLength(7);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmLapD);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmLapR).HasMaxLength(25);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmCand);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmCanr).HasMaxLength(25);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmPrev).HasMaxLength(20);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmData);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CMUsrA).HasMaxLength(10);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CMDatU).HasPrecision(14, 0);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CMUsrU).HasMaxLength(10);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CMDatC).HasPrecision(14, 0);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CMUsrC).HasMaxLength(10);
        }
