...
namespace FourPointImport.Data
{
    ...
    public class CoverageInsHist : Base
    {
        ...
        public static void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmIDN1).IsRequired(false);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmIDN2).HasPrecision(9, 0);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmFPrm).IsRequired(false);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmEfft).IsRequired(false);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmExpr).IsRequired(false);
            ...
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmLapD).IsRequired(false);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmLapR).HasMaxLength(25).IsRequired(false);
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmCand).IsRequired(false);
            ...
            modelBuilder.Entity<CoverageInsHist>().Property(x => x.CmData).IsRequired(false);
