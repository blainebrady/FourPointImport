...
namespace FourPointImport.Data
{
    ...
    public class PatronCustHist : Base
    {
        ...
        public static void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PatronCustHist>().Property(x => x.ImSufx).HasMaxLength(3).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.ImAdd1).HasMaxLength(25).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.ImAdd2).HasMaxLength(25).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.ImCity).HasMaxLength(25).IsRequired(false);
            ...
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ03).HasMaxLength(1).IsRequired(false);  
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ04).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ05).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ06).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ07).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ08).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ09).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ10).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ11).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ12).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ13).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ14).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ15).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ16).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ17).HasMaxLength(1).IsRequired(false);
            modelBuilder.Entity<PatronCustHist>().Property(x => x.IMHQ18).HasMaxLength(1).IsRequired(false);
